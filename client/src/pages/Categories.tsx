...
const categoryDescriptions: Record<string, { en: string; fr: string; ar: string }> = {
  cooking: {
    ...
    fr: 'Recettes algériennes traditionnelles, repas faits maison, pâtisseries et services de traiteur par des chefs maison qualifiés.',
    ar: 'وصفات جزائرية تقليدية، وجبات منزلية، حلويات وخدمات تقديم الطعام من طرف طهاة منزليين مهرة.',
  },
  sewing: {
    en: 'Tailoring, embroidery, traditional dress-making, alterations, and handcrafted textile art.',
    fr: 'Couture, broderie, confection de vêtements traditionnels, retouches et art textile fait main.',
    ar: 'الخياطة والتطريز وصناعة الأزياء التقليدية والتعديلات والفن النسيجي اليدوي.',
  },
  repairs: {
  ...
  cleaning: {
    ...
    fr: 'Nettoyage professionnel à domicile, nettoyage en profondeur, services de blanchisserie et nettoyage post-construction.',
                  ...
                  <div className="flex items-start gap-6">
                    ...
                    <div className="flex-1 space-y-3">
                      <div className="flex items-center gap-3 flex-wrap">
                        ...
                        <Badge variant="secondary">{cat.count} {i18n.language === 'ar' ? 'حرفي' : 'artisans'}</Badge>
                      </div>
