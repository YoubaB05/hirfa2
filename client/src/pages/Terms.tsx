...
const sections = [
  'acceptance', 'services', 'artisans', 'clients', 'conduct',
  'intellectual', 'privacy', 'disclaimer', 'changes', 'contact',
];
    ...
    <div className="min-h-screen bg-background">
      <div className="relative bg-gradient-to-br from-primary/10 via-background to-accent/10 py-16 border-b overflow-hidden">
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8 relative">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl">{t('terms.intro')}</p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8 py-16 max-w-3xl">
        <div className="space-y-10">
          {sections.map((section, index) => (
            <section key={section} data-testid={`terms-section-${section}`}>
